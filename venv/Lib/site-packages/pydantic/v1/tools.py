...
from pyd_test.v1.types import StrBytes
from pyd_test.v1.typing import display_as_type
...
if TYPE_CHECKING:
    from pyd_test.v1.typing import DictStrAny
...
def _get_parsing_type(type_: Any, *, type_name: Optional[NameFactory] = None) -> Any:
    from pyd_test.v1.main import create_model
